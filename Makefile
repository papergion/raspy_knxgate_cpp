...
#CFLAGS.common   := -std=c++17 -Wall -Wextra -Wno-unused-result
...
#	$(CC) $(CFLAGS) $(INC) knxgate_y.c knx_mqtt.c knx_hue.c -lpaho-mqtt3c -o $(TARGETDIR)/$(call MakeExe,knxgate_y) $(LIB)
#	$(CC) $(CFLAGS) $(INC) knxdiscover.c knx_mqtt_disc.c -lpaho-mqtt3c -o $(TARGETDIR)/$(call MakeExe,knxdiscover) $(LIB)
#	$(CC) $(CFLAGS) $(INC) knxsystem.c -o $(TARGETDIR)/$(call MakeExe,knxsystem) $(LIB)
